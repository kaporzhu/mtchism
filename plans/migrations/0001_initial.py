...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Plan'
        db.create_table(u'plans_plan', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'plans', ['Plan'])

        # Adding model 'Stage'
        db.create_table(u'plans_stage', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=64)),
        ...
        db.send_create_signal(u'plans', ['Stage'])

        # Adding model 'StageMeal'
        db.create_table(u'plans_stagemeal', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
        ...
        db.send_create_signal(u'plans', ['StageMeal'])


    def backwards(self, orm):
        # Deleting model 'Plan'
        db.delete_table(u'plans_plan')

        # Deleting model 'Stage'
        db.delete_table(u'plans_stage')

        # Deleting model 'StageMeal'
        db.delete_table(u'plans_stagemeal')
