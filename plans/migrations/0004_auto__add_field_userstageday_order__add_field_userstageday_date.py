...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserStageDay.order'
        db.add_column(u'plans_userstageday', 'order',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['orders.Order'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'UserStageDay.date'
        db.add_column(u'plans_userstageday', 'date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 4, 29, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserStageDay.order'
        db.delete_column(u'plans_userstageday', 'order_id')

        # Deleting field 'UserStageDay.date'
        db.delete_column(u'plans_userstageday', 'date')
