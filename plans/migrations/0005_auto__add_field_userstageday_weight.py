...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'UserStageDay.weight'
        db.add_column(u'plans_userstageday', 'weight',
                      self.gf('django.db.models.fields.FloatField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'UserStageDay.weight'
        db.delete_column(u'plans_userstageday', 'weight')
