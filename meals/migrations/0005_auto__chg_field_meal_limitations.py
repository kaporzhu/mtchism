...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Meal.limitations'
        db.alter_column(u'meals_meal', 'limitations', self.gf('django.db.models.fields.CharField')(max_length=64))

    def backwards(self, orm):

        # Changing field 'Meal.limitations'
        db.alter_column(u'meals_meal', 'limitations', self.gf('django.db.models.fields.CharField')(max_length=32))
