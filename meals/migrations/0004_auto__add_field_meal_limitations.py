...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Meal.limitations'
        db.add_column(u'meals_meal', 'limitations',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Meal.limitations'
        db.delete_column(u'meals_meal', 'limitations')
    ...
    models = {
        ...
        u'meals.meal': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'limitations': ('django.db.models.fields.CharField', [], {'max_length': '32', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '128'}),
