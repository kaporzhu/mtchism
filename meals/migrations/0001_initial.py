...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Dish'
        db.create_table(u'meals_dish', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'meals', ['Dish'])

        # Adding model 'DishFoods'
        db.create_table(u'meals_dishfoods', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('dish', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['meals.Dish'])),
        ...
        db.send_create_signal(u'meals', ['DishFoods'])

        # Adding model 'Meal'
        db.create_table(u'meals_meal', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('creator', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'])),
            ('created_at', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal(u'meals', ['Meal'])

        # Adding M2M table for field dishes on 'Meal'
        m2m_table_name = db.shorten_name(u'meals_meal_dishes')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('meal', models.ForeignKey(orm[u'meals.meal'], null=False)),
            ('dish', models.ForeignKey(orm[u'meals.dish'], null=False))
        ))
        db.create_unique(m2m_table_name, ['meal_id', 'dish_id'])


    def backwards(self, orm):
        # Deleting model 'Dish'
        db.delete_table(u'meals_dish')

        # Deleting model 'DishFoods'
        db.delete_table(u'meals_dishfoods')

        # Deleting model 'Meal'
        db.delete_table(u'meals_meal')

        # Removing M2M table for field dishes on 'Meal'
        db.delete_table(db.shorten_name(u'meals_meal_dishes'))
