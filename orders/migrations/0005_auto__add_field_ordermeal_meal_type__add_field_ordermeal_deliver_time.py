...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'OrderMeal.meal_type'
        db.add_column(u'orders_ordermeal', 'meal_type',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=16, blank=True),
                      keep_default=False)

        # Adding field 'OrderMeal.deliver_time'
        db.add_column(u'orders_ordermeal', 'deliver_time',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=16, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'OrderMeal.meal_type'
        db.delete_column(u'orders_ordermeal', 'meal_type')

        # Deleting field 'OrderMeal.deliver_time'
        db.delete_column(u'orders_ordermeal', 'deliver_time')
