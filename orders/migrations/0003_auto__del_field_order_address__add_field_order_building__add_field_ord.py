...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Order.building'
        db.add_column(u'orders_order', 'building',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['buildings.Building'], null=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Order.building'
        db.delete_column(u'orders_order', 'building_id')

        # Deleting field 'Order.location'
        db.delete_column(u'orders_order', 'location')
