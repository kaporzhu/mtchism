...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'orders_order', 'deliver_date', self.gf('django.db.models.fields.DateField')())

    def backwards(self, orm):

        # Changing field 'Order.deliver_date'
        db.alter_column(u'orders_order', 'deliver_date', self.gf('django.db.models.fields.DateField')(auto_now_add=True))
    ...
    models = {
        ...
        u'orders.order': {
            ...
            'created_at': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'creator': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['auth.User']"}),
            'deliver_date': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
